...
**Complete example**: See [examples/template-report.typ](https://github.com/lucifer1004/claude-skill-typst/tree/main/skills/typst/examples/template-report.typ) for a full template with headers, custom counters, note boxes, and multi-region document.
