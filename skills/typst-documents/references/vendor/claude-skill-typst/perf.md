...
```bash
typst compile https://github.com/lucifer1004/claude-skill-typst/tree/main/skills/typst/examples/perf-test.typ build/perf-test.pdf --root . --timings build/timings.json
python3 scripts/perf-timings.py build/timings.json
```
