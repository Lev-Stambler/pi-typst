...
**Complete example**: See [examples/package-example/](https://github.com/lucifer1004/claude-skill-typst/tree/main/skills/typst/examples/package-example) for a minimal publishable package with submodules.
